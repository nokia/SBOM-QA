...
| Ecosystem   | Compared Files                   | Differences file | Version Changes | New Packages | Removed Packages | License Changes  | 
|-------------|----------------------------------|------------------|----------------|--------------|------------------|-----------------|
| C           | [Ref-C.json](https://github.com/nokia/SBOM-QA/blob/main/C-NP/Reference/besser82_libxcrypt_8ecb92.json) vs [C.json](https://github.com/nokia/SBOM-QA/blob/main/C-NP/SBOM/ort%20.json) |      [Diff-CONAN.json](https://github.com/nokia/SBOM-QA/blob/main/C-NP/Difference/diff-ortdefault.json)       |  0   |   1    |  8         |   0     |
